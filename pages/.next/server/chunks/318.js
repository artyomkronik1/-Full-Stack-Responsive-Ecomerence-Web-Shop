...
const Footer = () => {
  ...
  }, /*#__PURE__*/external_react_default().createElement("p", null, "2022 JSM Headphones All rights reserverd"), /*#__PURE__*/external_react_default().createElement("p", {
    className: "icons"
...
const Navbar = () => {
  ...
  return /*#__PURE__*/external_react_default().createElement("div", {
    ...
    href: "/"
  }, "ARTIOM - HEADPHONES")), /*#__PURE__*/external_react_default().createElement("button", {
    type: "button",
    className: "cart-icon",
...
const getStripe = () => {
  if (!stripePromise) {
    stripePromise = (0,stripe_js_.loadStripe)("pk_test_51Hqmw9EnylLNWUqj3gbIK3wHZBXqH0HegicIlGA0etfwS9a5JpESWoFucZHdnWMp0q6xq6thYSZghQUSpLkE46wJ00HrkNMsOV");
  }
...
const Cart = () => {
  ...
  return /*#__PURE__*/external_react_default().createElement("div", {
    ...
    size: 150
  }), /*#__PURE__*/external_react_default().createElement("h3", null, "Your shopping bag is empty"), /*#__PURE__*/external_react_default().createElement(next_link["default"], {
    href: "/"
  }, /*#__PURE__*/external_react_default().createElement("button", {
    type: "button",
    onClick: () => setShowCart(false),
    ...
    className: "product",
    key: item._id
  }, item?.image[0] && /*#__PURE__*/external_react_default().createElement("img", {
    src: (0,client/* urlFor */.u)(item?.image[0]).url(),
...
const client = _sanity_client__WEBPACK_IMPORTED_MODULE_0___default()({
  ...
  useCdn: true,
  token: "skybTgaLI8V6ruKETUxKqQ83nk9brSX5pXeWN4z8v7CROu7j8AGN8BM7UsDd4306ZsU3JFBSgLvXsanbEMjHt7gjqjKijrQeqnBvcFQFyCn9DRi5dFOhKODmzhl3UqYfTstfR5JhC2ih6fly9kIaqIRKP0MWccWQo20lpxkY3hfr6VDiAp6o"
});
